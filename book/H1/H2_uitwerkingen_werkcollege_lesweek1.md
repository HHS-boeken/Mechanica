...
Ontbind de kracht $\overrightarrow{F_{A}}$ in $F_{A;x}$ en $F_{A;y}$ :
\begin{align}
F_{A;x} &=  |\overrightarrow{F_{A}}| \cdot \sin (\phi) \\
& = 8 \cdot \sin (\theta)
\end{align}

\begin{align}
F_{A;y} &=  |\overrightarrow{F_{A}}| \cdot \cos (\phi) \\
& = 8 \cdot \cos (\theta)
\end{align}

Ontbind de kracht $\overrightarrow{F_{B}}$ in $F_{B;x}$ en $F_{B;y}$ :
\begin{align}
